...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("tflite_model_runner_cc_threaded_simd.worker.js");
...
function __ZN6tflite13DumpArenaInfoERKNSt3__212basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEERKNS0_6vectorIiNS4_IiEEEEmRKNS9_INS_27ArenaAllocWithUsageIntervalENS4_ISE_EEEE() {
 err("missing function: _ZN6tflite13DumpArenaInfoERKNSt3__212basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEERKNS0_6vectorIiNS4_IiEEEEmRKNS9_INS_27ArenaAllocWithUsageIntervalENS4_ISE_EEEE");
 abort(-1);
}
...
function __mmap_js(len, prot, flags, fd, off, allocated, addr) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(4, 1, len, prot, flags, fd, off, allocated, addr);
 return -52;
}

function __munmap_js(addr, len, prot, flags, fd, offset) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 1, addr, len, prot, flags, fd, offset);
}
...
var proxiedFunctionTable = [ null, _proc_exit, exitOnMainThread, pthreadCreateProxied, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_seek, _fd_write ];
